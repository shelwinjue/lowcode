...
<img src="/pageData.png" class="globalImg" style="width:100%;max-width: 200px" />

点击“页面数据”，将出现页面数据编辑抽屉，如下所示：

<img src="/pageData-1.png" class="globalImg" style="width:100%;max-width: 700px" />
...
<video controls autoplay muted style="width: 100%;max-width: 1200px">
  <source src="/pageData.mp4" type="video/mp4">
